"""
Sensor component to monitor waste collection by Area Reiniging.
...
SENSOR_TYPES = {
    ...
    'grey': ['Residual', 'mdi:recycle'],
    'paper': ['Paper', 'mdi:recycle'],
    'green': ['Green', 'mdi:recycle'],
    'plastic': ['Plastic', 'mdi:recycle'],
    'remainder': ['Remainder', 'mdi:recycle'],
    'textile': ['Textile', 'mdi:recycle'],
    'tree': ['Trees', 'mdi:recycle']
}
...
def setup_platform(hass, config, add_entities, discovery_info=None):
    _LOGGER.debug("Setting up Area Reiniging API Reader...")
...
# Settings for Area Reiniging:
DEFAULT_BASEURL = 'https://wasteapi.2go-mobile.com/api/{}'
DEFAULT_COMPANYCODE = 'adc418da-d19b-11e5-ab30-625662870761'
DEFAULT_HEADERS = {
    'User-Agent': "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.106 Safari/537.36",
    'Referer': 'https://www.area-afval.nl/'
}
